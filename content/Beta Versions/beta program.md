...
**Step 1: Subscribe to the Beta Program**
Visit my [Ko-fi page](https://ko-fi.com/oxdcq), navigate to the Membership tab, and join the **Vertical Tabs Beta Program**.

> [!WARNING] Important: Read Before Subscribing
> Please review the [[beta faq|FAQ]] and [[security|Privacy Policy]] before subscribing. By joining the Beta Program, you acknowledge that you have read and agree to the [[terms|Terms and Conditions]].
...
<a class="vt-install-button" href="https://obsidian.md/plugins?id=obsidian42-brat" target="_blank">Install BRAT</a>
...
<a class="vt-install-button" href="obsidian://brat?plugin=https://github.com/oxdc/obsidian-vertical-tabs-beta-helper">Install Vertical Tabs Beta Helper</a>
